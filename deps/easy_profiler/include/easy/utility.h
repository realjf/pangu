...
namespace estd {
    ...
    namespace detail {
        template <class T, bool BiggerThanPtr>
        struct hasher {
            using type = const T&;
    ...
    template <class T>
    struct hash EASY_FINAL : public ::estd::detail::hasher<T, (sizeof(T) > sizeof(void*))> {
