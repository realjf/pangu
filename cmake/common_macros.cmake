...
macro(SETUP_APP projname version)
    ...
    file(GLOB_RECURSE DEPS_SRC_FILES LIST_DIRECTORIES true RELATIVE ${CMAKE_CURRENT_SOURCE_DIR} include/*.c??)
    file(GLOB_RECURSE DEPS_HEADER_FILES LIST_DIRECTORIES true RELATIVE ${CMAKE_CURRENT_SOURCE_DIR} include/*.h??)

    include_directories(src)
    add_executable(${PROJ_NAME} ${SRC_FILES} ${HEADER_FILES} ${DEPS_SRC_FILES} ${DEPS_HEADER_FILES})
    if(MSVC)
